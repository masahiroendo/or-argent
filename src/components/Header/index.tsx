...
import { Box, Button, Flex, Menu, MenuButton, MenuItem, MenuList, Show, Spacer } from '@chakra-ui/react';
...
const Header: FC = () => {
  return (
    <Flex bg="gray.100">
      <Box display="flex" alignItems="center" gap={2} marginStart={{ base: '10px', md: '75px' }}>
