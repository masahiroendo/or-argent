...
export const metalPricesTimeSeries = `${metalPricesApiEndpoint}/timeseries`;

export const makeMetalPricesTimeseries = (
  ...
  return `${metalPricesApiOHLCEndpoint}${date}?access_key=${METALS_API_KEY}&start_date${startDate}=&end_date=${endDate}&base=${base}&symbols=${currencySymbol}`;
};
